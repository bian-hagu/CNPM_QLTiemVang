...
namespace QLTiemVang.DTO
{
    ...
    {
        public SaleSlipInfo(int slipID, int productID, int  quan, float price, float total)
        {
            this.SlipID = slipID;
        ...
        public SaleSlipInfo(DataRow row)
        {
            this.SlipID = Convert.ToInt32(row["MaPhieuBanHang"]);
